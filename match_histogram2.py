...
SOURCE_IMAGE = "images/michele_signora/input.jpg"
REFERENCE_IMAGE = "images/michele_signora/refer.jpg"
MASK_IMAGE = "mask.jpg"
...
def main():
    ...
    try:
        image_src_name = sys.argv[2]
        image_ref_name = sys.argv[4]
    except:
        image_src_name = SOURCE_IMAGE
        image_ref_name = REFERENCE_IMAGE
 
    try:
        image_mask_name = sys.argv[6]
        # mask_provided = True
    except:
